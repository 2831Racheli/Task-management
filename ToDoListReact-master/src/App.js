...
function App() {
  ...
  const handleAuth = async (e) => {
    ...
    try {
        ...
        Swal.fire({ icon: 'error', title: 'שגיאה', text: 'בדקי את הפרטים' });
    }
  };
    ...
    return (
      <div className="authContainer">
        <div className="authCard">
          <h2 className="authTitle">{authData.isLogin ? "ברוכים הבאים" : "יצירת חשבון"}</h2>
      ...
      <main className="mainContent">
        <div className="contentWrapper">
            ...
            <div className="todoContainer">
                ...
                {filteredTodos.length === 0 && <p className="emptyMsg">אין משימות להצגה</p>}
            </div>
        </div>
      </main>
    </div>
